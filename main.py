...
if args.save_dir_norm_inf_model:
    save_checkpoint(model, os.path.join(args.save_dir_norm_inf_model, 'epoch-{}.pt'.format(args.epochs)))

if args.save_dir_covid_non_model:
    save_checkpoint(model, os.path.join(args.save_dir_covid_non_model, 'epoch-{}.pt'.format(args.epochs)))