...
from test import predict, input_from_model1
...
model1 = norm_infected_model()
path1 = '' # Xavier please add the path to your best model 
device = 'cpu'
...
all_pred, test_loss, accuracy, recall, precision = predict(val_loader, model1, path1, device)

model2 = covid_non_model()
path2 = './checkpoints/model2_6/epoch-9.pt'

input_m1 = input_from_model1() # Xavier which function do i call to get your list of images, list of labels and list of pred values 

all_pred, test_loss, accuracy, recall, precision = predict(input_m1, model2, path2, device)
