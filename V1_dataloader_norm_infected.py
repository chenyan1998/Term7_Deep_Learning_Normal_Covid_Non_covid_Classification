...
class Lung_Train_Dataset(Dataset):
    ...
    def __init__(self):
        ...
        self.dataset_numbers = {'train_normal': 1341,                                'train_infected': 3875}
        
        # Path to images for different parts of the dataset
        self.dataset_paths = {'train_normal': './dataset/train/normal',                              'train_infected': './dataset/train/infected'}
...
class Lung_Test_Dataset(Dataset):
    ...
    def __init__(self):
        ...
        # Number of images in each part of the dataset
        self.dataset_numbers = {'test_normal': 234,                                'test_infected': 380}
        
        # Path to images for different parts of the dataset
        self.dataset_paths = {'test_normal': './dataset/test/normal',                              'test_infected': './dataset/test/infected'}
...
class Lung_Val_Dataset(Dataset):
    ...
    def __init__(self):
        ...
        # Number of images in each part of the dataset
        self.dataset_numbers = {'val_normal': 8,                                'val_infected': 16}
        
        # Path to images for different parts of the dataset
        self.dataset_paths = {'val_normal': './dataset/val/normal',                              'val_infected': './dataset/val/infected'}
