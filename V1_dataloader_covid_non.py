...
class Lung_Dataset(Dataset):
    ...
    def __init__(self):
        ...
        self.dataset_numbers = {'train_noncovid': 2530,                                'train_covid': 1345,                                'val_noncovid': 8,                                'val_covid': 8,                                'test_noncovid': 242,                                'test_covid': 138}
        
        # Path to images for different parts of the dataset
        self.dataset_paths = {'train_noncovid': './dataset/train/infected/non-covid',                              'train_covid': './dataset/train/infected/covid',                              'val_noncovid': './dataset/val/infected/non-covid/',                              'val_covid': './dataset/val/infected/covid/',                              'test_noncovid': './dataset/test/infected/non-covid',                              'test_covid': './dataset/test/infected/covid'}
    ...
    def open_img(self, group_val, class_val1, index_val):
        ...
        assert class_val1 in self.classes.values(), err_msg
        
        max_val = self.dataset_numbers['{}_{}'.format(group_val, class_val1)]
...
#ld = Lung_Dataset()
#ld.describe()
#im = ld.open_img('train','noncovid', 1)
#print(im.shape)
#print(im)
#ld.show_img('train', 'covid', 1)
